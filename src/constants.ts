...
export const DEMO_LUSOFONE_PROFILES: UserProfile[] = [
  ...
  },
  {
    ...
    cityName: 'Luanda',
    intent: 'serious',
    interests: ['Negócios & Empreendedorismo', 'Gastronomia Lusófona', 'Música (Semba, Kizomba, Samba, Fado, Morna, Marrabenta)'],
    bio: 'Economista e amante de boa comida em Luanda. Acredito na força das raízes africanas e nas pontes de afeto entre os nossos países irmãos.',
    profilePhoto: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=700&auto=format&fit=crop&q=80',
    visibility: 'public',
    verificationStatus: 'verified',
    online: true,
  ...
  },
  {
    ...
    cityName: 'Benguela',
    intent: 'dating',
    interests: ['Natureza & Praias', 'Dança', 'Viagens & Culturas'],
    bio: 'Benguelense que adora a brisa da Praia Morena. Gosto de sorrisos leves, boas partilhas e pessoas que valorizam o diálogo sincero.',
    profilePhoto: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=700&auto=format&fit=crop&q=80',
    visibility: 'public',
    verificationStatus: 'verified',
    online: false,
  ...
  },
  {
    ...
    cityName: 'Porto',
    intent: 'serious',
    interests: ['Cinema & Artes Visuais', 'Gastronomia Lusófona', 'Poesia & Escrita'],
    bio: 'Portuense dedicada ao design editorial e à fotografia analógica. Adoro tardes à beira do Douro, conversas profundas e trocas culturais autênticas.',
  ...
  },
  {
    ...
    bio: 'Vive entre Lisboa e a Costa da Caparica. Engenheiro de energias renováveis apaixonado por ritmos africanos e noites estreladas.',
    profilePhoto: 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=700&auto=format&fit=crop&q=80',
    visibility: 'public',
    verificationStatus: 'verified',
    online: true,
  ...
  },
  {
    ...
    profilePhoto: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=700&auto=format&fit=crop&q=80',
    visibility: 'public',
    verificationStatus: 'verified',
    online: true,
  ...
  },
  {
    ...
    cityName: 'São Paulo',
    intent: 'dating',
    interests: ['Gastronomia Lusófona', 'Cinema & Artes Visuais', 'Tecnologia & Inovação'],
    bio: 'Jornalista cultural paulistano. Fascinado pelas conexões linguísticas e musicais do Atlântico.',
    profilePhoto: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=700&auto=format&fit=crop&q=80',
    visibility: 'public',
    verificationStatus: 'verified',
    online: false,
